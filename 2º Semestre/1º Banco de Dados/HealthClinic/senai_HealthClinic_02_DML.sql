...
INSERT INTO Usuario(Nome,Senha,Email,DataNascimento)
	VALUES('Enzo','123','Enzo@gmail.com','2006-11-30')

INSERT INTO Usuario(Nome,Senha,Email,DataNascimento)
	VALUES('Gustav','123','gustav@gmail.com','2007-06-30')

INSERT INTO Especialidade(Especialidade)
	VALUES('Urologista'),('Ginecologista')
...
INSERT INTO Consulta(IdMedico,IdPaciente,Dia,Hora,Prontuario)
	VALUES(1,2,'2023-08-17','17:00','O paciente está em perfeito estado para trabalhar')
